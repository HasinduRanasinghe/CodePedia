...
const AddNewChallenge = ({ isDark }) => {
    ...
    const handleAddChallenge = async () => {
        ...
        if (!title || !description || !criteria || !timerDurationInMinutes || difficultyLevel === 'Select Difficulty Level' || !expectedOutput) {
            ...
            <div>
                ...
                <div className="input-container" style={{ marginTop: "0px" }}>
                    ...
                    <input
                        ...
                        required
                    />
                    <label className={`primary-form-element ${isDark ? 'dark' : 'light'}`} htmlFor="challengeExpectedOutput">Expected Output</label>
