...
import ChallengeResults from './main-components/challengers-components/ChallengeResults'
    ...
    <div  className={`main scrollable-container ${isDark? 'scrollable-container-dark' : 'scrollable-container-light'}`}>
      {isLogin &&
        <Routes>
          ...
          <Route path='/challenges/challengeResults' element={<ChallengeResults isDark={isDark}/>}/>
          <Route path='/challenges/leaderboard' element={<Leaderboard isDark={isDark}/>}/>
